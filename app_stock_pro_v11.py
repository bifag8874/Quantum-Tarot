...
st.title(f"🔮 V14.3 量子塔羅 - {st.session_state.user_id} 的專屬空間")
...
"""
                try:
                    ...
                    st.caption("建議檢查 API Key 權限或暫時改用其他模型。")
